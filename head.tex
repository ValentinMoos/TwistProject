...
\newcommand{\qprop}{\blacktriangle}  % propagator symbol
\newcommand{\twoneop}[3]{\mathcal{X}_{#3}^{#2}\left(#1\right) }
\newcommand{\twtwoop}[5]{\mathcal{X}_{#4,#5}^{#3}\left(#1,#2\right)}
...
\newcommand{\ppr}{\overrightarrow{\partial_+}}
\newcommand{\ppl}{\overleftarrow{\partial_+}}
\newcommand{\cov} {D}
...
\newcommand{\ab}{\beta'}
\newcommand{\ag}{\gamma'}
\newcommand{\apbar}{\overline{\ap}}
\newcommand{\bpbar}{\overline{\bp}}
\newcommand{\gpbar}{\overline{\gp}}
